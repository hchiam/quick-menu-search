(function () {
  ...
  function createPalette() {
    ...
    div.style.cssText =
      "all: initial; padding-top: 20px; position: fixed; left: 25%; top: 25vh; width: 50%; height: 50%; z-index: 9999; border: 1rem solid rgba(0, 0, 255, 0.75); background: rgba(255,255,255,0.95); color: black; overflow-y: auto; border-radius: 5px; font-family: avenir, arial, tahoma; box-shadow: inset 0 -50px 50px -55px rgba(0, 0, 0, 1);";
    ...
    button.style.cssText =
      "all: initial; position: absolute; right: 1rem; background: blue; padding: 0.5rem; margin: 0.75rem; display: inline; border-radius: 5px; font-family: avenir, arial, tahoma;";
    button.title = "Close";
    ...
    h1.style.cssText =
      "all: initial; margin: 10px; font-family: avenir, arial, tahoma; font-weight: bold;";
    div.appendChild(h1);

    var searchBox = document.createElement("INPUT");
    searchBox.id = "quick-search-palette-input";
    searchBox.style.cssText =
      "all: initial !important; background: rgba(255,0,0,0.1) !important; border: solid red 1px !important; border-radius: 5px !important; padding: 5px !important; font-family: avenir, arial !important;";
    searchBox.placeholder = "Start typing";
    searchBox.onkeyup = function () {
      document.getElementById("quick-search-palette-container").innerHTML = "";
      document.getElementById("quick-search-palette-container").innerHTML =
        findText(searchBox.value);
    };
  ...
  function findText(text) {
    ...
    return (
      "<strong>(Hint: Tab or Shift+Tab)</strong><br/><br/>" +
      results.join("<br/><br/>")
    );
  }
